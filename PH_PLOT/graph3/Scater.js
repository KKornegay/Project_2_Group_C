...
function makeResponsive() {
    ...
    // Read CSV
    d3.csv("2005cost.csv").then(function(winData) {

        // // create scales
        var xLinearScale = d3.scaleLinear()
          .domain([40, 150])      // hard set
          
          //.domain(d3.extent(winData, d => d.wins))
          .range([0, svgWidth/1.5]);                                                                                        //
        ...
        // append axes
        chartGroup.append("g")
          .attr("transform", `translate(0, ${svgHeight/1.5})`)                                                            //
          .call(xAxis);
        ...
        var line = d3.line()
          ...
          .y(d => yLinearScale(d.cost_per_win/1.5));                                                                      //
        ...
        var circlesGroup = chartGroup.selectAll("circle")
          ...
          .attr("cy", d => yLinearScale(d.cost_per_win/1.5))                                                     //
          .attr("r", "10")
        ...
        var toolTip = d3.tip()
          ...
          .offset([80, -60])
          .html(function(d) {
            return (`<strong>Championship: ${d.championship}<strong><hr>${d.team}<strong><hr>Team Salary ${formatter.format(d.team_salary)} $ 
